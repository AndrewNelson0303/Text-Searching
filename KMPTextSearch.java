    ...
    //Following method creates look up table for KMP Search
        public static int[] createTab (String pat){
            int [] tab =new int[pat.length()];
            int i = 1;
            int m = 0;
            while (i<pat.length()){
                if(pat.charAt(i)==pat.charAt(m)){
                    m++;
                    tab[i]=m;
                    i++;
                }
                else if((pat.charAt(i)!=pat.charAt(m))&&m!=0){
                    m=tab[m-1];
                }
                else {
                    tab[i]=0;
    ...
    //Following method finds the indices where pattern can be found in text
        public static ArrayList<Integer> kmpSearch(String pat, String text){
            ArrayList<Integer> results = new ArrayList<Integer>();
            int[] aux = createTab(pat);
            int i=0;
            int j=0;
            while(j<text.length()){
     ...
     */
            ...
            // Creating the scanner that will be used for user to implement own text and pattern
            Scanner scan = new Scanner(System.in);
    
            
        //    File file = new File("C:\\Users\\Andrew Nelson\\Downloads");
        //    Scanner scanFile = new Scanner(file);
        //    System.out.println(scanFile.nextLine());

        //    System.out.println("Type out a String to represent a text");
        //    String text = scan.nextLine();
            ...
            //Get line that will be found
            System.out.println("Type out a String to represent the pattern that will be searched for in the text");
            String pattern = scan.nextLine();
            
            //Starts the timer for how long KMP search takes
            double startTime = System.currentTimeMillis();

            // Search for the pattern in the text and create an arraylist that represents where the pattern was found
            ArrayList<Integer> results = kmpSearch(pattern, text);
            int count=0;
            if(results.isEmpty()){
                System.out.println("There are no occurences of the pattern in the text");
            }
            else{
           ...
           //     System.out.print(num + ", ");
            ...
            System.out.println("are/is the " + count+ " indices/index at which \"" + pattern+ "\" can be found");// + text+"\".");
            }
        
        //End Time
        double endTime = System.currentTimeMillis();
        double runningTime = (endTime - startTime);
        System.out.println("Program execution time: " + runningTime + "milliseconds");
        }
    }
